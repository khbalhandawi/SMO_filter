...
hold on;
plot(time_raw, pos_est_cpp(:,1), '-r', 'linewidth',1.5);
plot(time_raw, groundtruth_pos_ds(:,1), '-g', 'linewidth',1.5);
plot(time_raw, groundtruth_pos_true(:,1), '-k', 'linewidth',1.5);
xlabel('Time (s)','interpreter','latex');
ylabel('Meter','interpreter','latex');
...
hold on;
plot(time_raw, pos_est_cpp(:,2), '-r', 'linewidth',1.5);
plot(time_raw, groundtruth_pos_ds(:,2), '-g', 'linewidth',1.5);
plot(time_raw, groundtruth_pos_true(:,2),'-k', 'linewidth',1.5);
xlabel('Time (s)','interpreter','latex');
ylabel('Meter','interpreter','latex');
...
hold on;
est_h = plot(time_raw, pos_est_cpp(:,3), '-r', 'linewidth',1.5);
ds_h = plot(time_raw, groundtruth_pos_ds(:,3), '-g', 'linewidth',1.5);
true_h = plot(time_raw, groundtruth_pos_true(:,3), '-k', 'linewidth',1.5);
xlabel('Time (s)','interpreter','latex');
ylabel('Meter','interpreter','latex');
...
legend_entries = [{'Estimated position'}, {'DownSampled position'}, {'True Position'}];
...
% export_fig(['./Sample_plots/response_delay_',num2str(n_delay),'_c_',num2str(c),'_l_',num2str(lambda),'.pdf'],'-p0.002',fig1); 
% export_fig(['./Sample_plots/response_delay_',num2str(n_delay),'_c_',num2str(c),'_l_',num2str(lambda),'.png'],'-p0.002','-r600',fig1); 
...
% export_fig(['./Sample_plots/1D_response_delay_',num2str(n_delay),'_c_',num2str(c),'_l_',num2str(lambda),'.pdf'],'-p0.002',fig2); 
% export_fig(['./Sample_plots/1D_response_delay_',num2str(n_delay),'_c_',num2str(c),'_l_',num2str(lambda),'.png'],'-p0.002','-r600',fig2); 
